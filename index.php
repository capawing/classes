...
<br> that they need to paid for.before the time of departure and arrival.<br>The fare guide table are very useful information which 
  we can find <br>it here.the selection methods and payments methods,which make us hassle free, safe and convient.
<br>Driver table it contains the personal information about the Driver,where they can login and star monitoring about 
<br>the passenger status,if they already verifying their ticket or not.<br>the Admin management personnel he /she is the Authorized 
  personnel to add user, update DSR table and can view the drivers ratings.</br> and verify riders tickets.</p>
